    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < numP1Threads; i++) {
            ...
            SkierThread2 thread1 = new SkierThread2(5, "2019", "7", startSkiers, endSkiers,
                1, 90, numLifts, numP1Requests, latch1, latchSum, results, recordElement);
            thread1.start();
        ...
        for (int i = 0; i < numP2Threads; i++) {
            ...
            SkierThread2 thread2 = new SkierThread2(5, "2019", "7", startSkiers, endSkiers,
                91, 360, numLifts, numP2Requests, latch2, latchSum, results, recordElement);
            thread2.start();
        ...
        for (int i = 0; i < numP2Threads; i++) {
            ...
            SkierThread2 thread3 = new SkierThread2(5, "2019", "7", startSkiers, endSkiers,
                361, 420, numLifts, numP3Requests, latch3, latchSum, results, recordElement);
            thread3.start();
        ...
        System.out.println("Throughput: " + Record2.getThroughPut() + " requests/second");
        ...
        Record2 recordProcessor = new Record2(recordList, Record2.getThroughPut());
