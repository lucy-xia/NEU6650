    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < numP1Threads; i++) {
            ...
            SkierThread thread = new SkierThread(5, "2019", "7", startSkiers, endSkiers,
                1, 90, numLifts, numP1Requests, latch1, latchSum, results);
            thread.start();
        }
        latch1.await();
        ...
        for (int i = 0; i < numP2Threads; i++) {
            ...
            SkierThread thread = new SkierThread(5, "2019", "7", startSkiers, endSkiers,
                91, 360, numLifts, numP2Requests, latch2, latchSum, results);
            thread.start();
        }
        latch2.await();
        ...
        for (int i = 0; i < numP2Threads; i++) {
            ...
            SkierThread thread = new SkierThread(5, "2019", "7", startSkiers, endSkiers,
                361, 420, numLifts, numP3Requests, latch3, latchSum, results);
            thread.start();
        }
        latchSum.await();
